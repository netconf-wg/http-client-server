...
command="yanglint ../ietf-crypto-types@*.yang ../ietf-truststore@*.yang ../ietf-keystore@*.yang ../ietf-tcp-common@*.yang ../ietf-tcp-client@*.yang ../ietf-tls-common@*.yang ../ietf-tls-client@*.yang ../ietf-udp-client.yang ./ietf-origin.yang $name ex-http-client.xml"
run_unix_cmd $LINENO "$command" 0
printf "okay.\n"
rm $name
...
name=`ls -1 ../ietf-http-client\@*.yang | sed 's/\.\.\///'`
sed 's/^}/container http-client { uses http-client-grouping; }}/' ../ietf-http-client\@*.yang > $name
command="yanglint -m ../ietf-crypto-types@*.yang ../ietf-truststore@*.yang ../ietf-keystore@*.yang ../ietf-tcp-common@*.yang ../ietf-tcp-client@*.yang ../ietf-tls-common@*.yang ../ietf-tls-client@*.yang ../ietf-udp-client.yang ./ietf-origin.yang $name ex-http-client-proxy.xml ../../trust-anchors/refs/ex-truststore.xml ../../keystore/refs/ex-keystore.xml"
run_unix_cmd $LINENO "$command" 0
printf "okay.\n"
rm $name
